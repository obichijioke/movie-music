...
const MusicListItem = ({ data }) => {
  return (
    <div className="flex items-center justify-between py-2 px-3 w-full h-[50px] bg-[#232429] rounded-lg hover:bg-[#2b2e35] cursor-pointer">
      <div className="flex items-center gap-4">
        <img
          src="https://lh3.googleusercontent.com/eC9DfRcYSk4FE-fvDCJSu_4xsKdVMKxwmFTYFZwP8OqB7R4TKxAjKoR-Kp1lXeRi2WddPFYulSte4eW-=w150-h150-l90-rj"
          alt=""
          className="w-9 h-9 rounded-md"
        />
        <p className="text-[#9d9d9e] font-medium">1</p>
        <p className="text-[#cfcfd1] font-medium">Talk Me Down</p>
      </div>
